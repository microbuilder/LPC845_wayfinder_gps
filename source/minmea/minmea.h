...
/* Alias for timegm which isn't available with MCUXpresso's libc. */
#define timegm  mktime

struct minmea_timespec {
    time_t tv_sec;
 ...
 */
int minmea_gettime(struct minmea_timespec *ts, const struct minmea_date *date, const struct minmea_time *time_);
